...
func TestConn(t *testing.T, mp MakePipe) {
	...
	timeoutWrapper(t, mp, testPresentTimeout) // maybe broken on travis
...
func timeoutWrapper(t *testing.T, mp MakePipe, f connTesterFn) {
	c1, c2, stop, err := mp()
	if err != nil {
...
func testBasicIOMini(t *testing.T, c1, c2 net.Conn) {
	testBasicIO(t, c1, c2, 1)
}

func testBasicIOSmall(t *testing.T, c1, c2 net.Conn) {
	testBasicIO(t, c1, c2, FrameMaxPayloadSize)
}

func testBasicIOMedium(t *testing.T, c1, c2 net.Conn) {
	testBasicIO(t, c1, c2, FrameMaxPayloadSize+1)
}

func testBasicIOLarge(t *testing.T, c1, c2 net.Conn) {
	testBasicIO(t, c1, c2, FrameMaxPayloadSize*10+7)
}

// testBasicIO tests that the data sent on c1 is properly received on c2.
func testBasicIO(t *testing.T, c1, c2 net.Conn, wantLength int) {
	want := make([]byte, wantLength)
