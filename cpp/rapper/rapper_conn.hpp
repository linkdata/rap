...
class conn : public boost::enable_shared_from_this<conn<exchange_t>>,
 ...
 public:
  ...
  void read_stream(char *buf_ptr, size_t buf_max) {
    ...
    socket_.async_read_some(
        ...
        boost::bind(&conn_type::handle_read, this->shared_from_this(),
  ...
  void write_stream(const char *src_ptr, size_t src_len) {
    ...
    boost::asio::async_write(
        ...
        boost::bind(&conn_type::handle_write, this->shared_from_this(),
                    boost::asio::placeholders::error,
                    boost::asio::placeholders::bytes_transferred));
    return;
  }
